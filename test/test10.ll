...
okay:
        ...
        store i32 %tmp.8, i32* %tmp.9
        %tmp.10 = add i32 0, 0
        %tmp.11 = getelementptr %Main, %Main* %tmp.6, i32 0, i32 1
        store i32 %tmp.10, i32* %tmp.11
        ret %Main* %tmp.6
abort:
        call void @abort( )
        unreachable
...
loop.3:
        %tmp.21 = alloca %Main*
        store %Main* %self, %Main** %tmp.21
        %tmp.22 = load %Main*, %Main** %tmp.21
        %tmp.23 = getelementptr %Main, %Main* %tmp.22, i32 0, i32 1
        %tmp.24 = load i32, i32* %tmp.23
        %tmp.25 = add i32 0, 1
        %tmp.26 = add i32 %tmp.24, %tmp.25
        %tmp.27 = alloca %Main*
        store %Main* %self, %Main** %tmp.27
        %tmp.28 = load %Main*, %Main** %tmp.27
        %tmp.29 = getelementptr %Main, %Main* %tmp.28, i32 0, i32 1
        store i32 %tmp.26, i32* %tmp.29
        br label %cond.3

break.3:
        %tmp.30 = alloca %Main*
        store %Main* %self, %Main** %tmp.30
        %tmp.31 = load %Main*, %Main** %tmp.30
        %tmp.32 = getelementptr %Main, %Main* %tmp.31, i32 0, i32 1
        %tmp.33 = load i32, i32* %tmp.32
        %tmp.34 = alloca %Main*
        store %Main* %self,%Main** %tmp.34
        %tmp.35 = load %Main*, %Main** %tmp.34
        %tmp.36 = getelementptr %Main, %Main* %tmp.35, i32 0, i32 0
        %tmp.37 = load %_Main_vtable*, %_Main_vtable** %tmp.36
        %tmp.38 = getelementptr %_Main_vtable, %_Main_vtable* %tmp.37, i32 0, i32 8
        %tmp.39 = load %Main*(%Main*, i32)*, %Main*(%Main*, i32)** %tmp.38
        %tmp.40 = call %Main*(%Main*, i32) %tmp.39(%Main* %tmp.35, i32 %tmp.33)
        %tmp.41 = add i32 0, 0
        ret i32 %tmp.41
