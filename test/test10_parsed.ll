...
okay:                                             ; preds = %entry
  ...
  store i32 0, i32* %tmp.9, align 4
  %tmp.11 = getelementptr %Main, %Main* %tmp.6, i32 0, i32 1
  store i32 0, i32* %tmp.11, align 4
  ret %Main* %tmp.6
...
entry:
  ...
  br i1 %tmp.14, label %abort, label %cond.3

cond.3:                                           ; preds = %entry, %loop.3
  ...
  %tmp.20 = icmp sle i32 %tmp.18, 100
