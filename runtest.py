    ...
    for filename in os.listdir(test_dir):
        if filename.endswith(".c"):
            ...
            compile_sccp_cmd = f"""
                                ...
                                opt-15 -load-pass-plugin=build/libUnitProject.so -passes="mem2reg,loop-simplify,unit-licm,unit-sccp,adce,simplifycfg" {file_name}_c.ll -S -o {file_name}_parsed.ll &&
