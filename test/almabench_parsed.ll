...
define dso_local void @planetpv(ptr noundef %0, i32 noundef %1, ptr noundef %2) #0 {
  ...
  %112 = getelementptr inbounds [8 x [9 x double]], ptr @kp, i64 0, i64 %106
  %113 = getelementptr inbounds [8 x [10 x double]], ptr @kq, i64 0, i64 %107
  %114 = getelementptr inbounds [8 x [9 x double]], ptr @ca, i64 0, i64 %108
  %115 = getelementptr inbounds [8 x [9 x double]], ptr @sa, i64 0, i64 %109
  %116 = getelementptr inbounds [8 x [10 x double]], ptr @cl, i64 0, i64 %110
  %117 = getelementptr inbounds [8 x [10 x double]], ptr @sl, i64 0, i64 %111
  br label %118

118:                                              ; preds = %151, %3
  %.03 = phi i32 [ 0, %3 ], [ %152, %151 ]
  %.02 = phi double [ %24, %3 ], [ %139, %151 ]
  %.01 = phi double [ %40, %3 ], [ %150, %151 ]
  %119 = icmp slt i32 %.03, 8
  br i1 %119, label %120, label %153

120:                                              ; preds = %118
  %121 = sext i32 %.03 to i64
  %122 = getelementptr inbounds [9 x double], ptr %112, i64 0, i64 %121
  %123 = load double, ptr %122, align 8
  %124 = fmul double %123, %105
  %125 = sext i32 %.03 to i64
  %126 = getelementptr inbounds [10 x double], ptr %113, i64 0, i64 %125
  %127 = load double, ptr %126, align 8
  %128 = fmul double %127, %105
  %129 = sext i32 %.03 to i64
  %130 = getelementptr inbounds [9 x double], ptr %114, i64 0, i64 %129
  %131 = load double, ptr %130, align 8
  %132 = call double @cos(double noundef %124) #5
  %133 = sext i32 %.03 to i64
  %134 = getelementptr inbounds [9 x double], ptr %115, i64 0, i64 %133
  %135 = load double, ptr %134, align 8
  %136 = call double @sin(double noundef %124) #5
  %137 = fmul double %135, %136
  %138 = call double @llvm.fmuladd.f64(double %131, double %132, double %137)
  %139 = call double @llvm.fmuladd.f64(double %138, double 0x3E7AD7F29ABCAF48, double %.02)
  %140 = sext i32 %.03 to i64
  %141 = getelementptr inbounds [10 x double], ptr %116, i64 0, i64 %140
  %142 = load double, ptr %141, align 8
  %143 = call double @cos(double noundef %128) #5
  %144 = sext i32 %.03 to i64
  %145 = getelementptr inbounds [10 x double], ptr %117, i64 0, i64 %144
  %146 = load double, ptr %145, align 8
  %147 = call double @sin(double noundef %128) #5
...
153:                                              ; preds = %118
  ...
  %176 = getelementptr inbounds [8 x [10 x double]], ptr @kq, i64 0, i64 %173
  %177 = getelementptr inbounds [8 x [10 x double]], ptr @cl, i64 0, i64 %174
  %178 = getelementptr inbounds [8 x [10 x double]], ptr @sl, i64 0, i64 %175
  br label %179

179:                                              ; preds = %198, %153
  %.14 = phi i32 [ 8, %153 ], [ %199, %198 ]
  %.1 = phi double [ %.01, %153 ], [ %197, %198 ]
  %180 = icmp sle i32 %.14, 9
  br i1 %180, label %181, label %200

181:                                              ; preds = %179
  %182 = sext i32 %.14 to i64
  %183 = getelementptr inbounds [10 x double], ptr %176, i64 0, i64 %182
  %184 = load double, ptr %183, align 8
  %185 = fmul double %184, %105
  %186 = sext i32 %.14 to i64
  %187 = getelementptr inbounds [10 x double], ptr %177, i64 0, i64 %186
  %188 = load double, ptr %187, align 8
  %189 = call double @cos(double noundef %185) #5
  %190 = sext i32 %.14 to i64
  %191 = getelementptr inbounds [10 x double], ptr %178, i64 0, i64 %190
  %192 = load double, ptr %191, align 8
  %193 = call double @sin(double noundef %185) #5
...
206:                                              ; preds = %220, %200
  ...
  %207 = fsub double %202, %.0
  %208 = call double @sin(double noundef %.0) #5
  %209 = call double @llvm.fmuladd.f64(double %54, double %208, double %207)
  %210 = call double @cos(double noundef %.0) #5
  %211 = call double @llvm.fmuladd.f64(double %205, double %210, double 1.000000e+00)
...
20:                                               ; preds = %19, %2
  %21 = getelementptr inbounds [2 x double], ptr %3, i64 0, i64 0
  %22 = getelementptr inbounds [2 x double], ptr %3, i64 0, i64 1
  %23 = getelementptr inbounds [2 x double], ptr %3, i64 0, i64 0
  %24 = getelementptr inbounds [2 x double], ptr %3, i64 0, i64 0
  %25 = getelementptr inbounds [2 x [3 x double]], ptr %4, i64 0, i64 0
  %26 = getelementptr inbounds [2 x [3 x double]], ptr %4, i64 0, i64 0
  br label %27

27:                                               ; preds = %47, %20
  %.13 = phi i32 [ 0, %20 ], [ %48, %47 ]
  %28 = icmp slt i32 %.13, 20
  br i1 %28, label %29, label %49

29:                                               ; preds = %27
  store double 0x4142B42C80000000, ptr %21, align 16
  store double 0.000000e+00, ptr %22, align 8
  br label %30

30:                                               ; preds = %44, %29
  %.01 = phi i32 [ 0, %29 ], [ %45, %44 ]
  %31 = icmp slt i32 %.01, 36525
  br i1 %31, label %32, label %46

32:                                               ; preds = %30
  %33 = load double, ptr %23, align 16
  %34 = fadd double %33, 1.000000e+00
  store double %34, ptr %23, align 16
  br label %35
