; ModuleID = 'test/test16.ll'
source_filename = "test/test16.ll"
...
%Main = type { %_Main_vtable*, %Derp2* }
%Derp2 = type { %_Derp2_vtable* }
%_Derp2_vtable = type { i32, i32, i8*, %Derp2* ()*, %Object* (%Derp2*)*, %String* (%Derp2*)*, %Derp2* (%Derp2*)*, %String* (%Derp2*)*, %String* (%Derp2*)* }
%_Derp1_vtable = type { i32, i32, i8*, %Derp1* ()*, %Object* (%Derp1*)*, %String* (%Derp1*)*, %Derp1* (%Derp1*)*, %String* (%Derp1*)* }
%Derp1 = type { %_Derp1_vtable* }
...
@_Derp1_vtable_prototype = constant %_Derp1_vtable { i32 6, i32 ptrtoint (%Derp1* getelementptr (%Derp1, %Derp1* null, i32 1) to i32), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.Derp1, i32 0, i32 0), %Derp1* ()* @Derp1_new, %Object* (%Derp1*)* bitcast (%Object* (%Object*)* @Object_abort to %Object* (%Derp1*)*), %String* (%Derp1*)* bitcast (%String* (%Object*)* @Object_type_name to %String* (%Derp1*)*), %Derp1* (%Derp1*)* bitcast (%Object* (%Object*)* @Object_copy to %Derp1* (%Derp1*)*), %String* (%Derp1*)* @Derp1.derp }
@str.Derp2 = internal constant [6 x i8] c"Derp2\00"
@_Derp2_vtable_prototype = constant %_Derp2_vtable { i32 7, i32 ptrtoint (%Derp2* getelementptr (%Derp2, %Derp2* null, i32 1) to i32), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.Derp2, i32 0, i32 0), %Derp2* ()* @Derp2_new, %Object* (%Derp2*)* bitcast (%Object* (%Object*)* @Object_abort to %Object* (%Derp2*)*), %String* (%Derp2*)* bitcast (%String* (%Object*)* @Object_type_name to %String* (%Derp2*)*), %Derp2* (%Derp2*)* bitcast (%Object* (%Object*)* @Object_copy to %Derp2* (%Derp2*)*), %String* (%Derp2*)* bitcast (%String* (%Derp1*)* @Derp1.derp to %String* (%Derp2*)*), %String* (%Derp2*)* @Derp2.derp }
@str.3 = internal constant [14 x i8] c"<basic class>\00"
@String.3 = constant %String { %_String_vtable* @_String_vtable_prototype, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.3, i32 0, i32 0) }
...
entry:
  %tmp.8 = alloca %Main*, align 8
  store %Main* %self, %Main** %tmp.8, align 8
  %tmp.9 = load %Main*, %Main** %tmp.8, align 8
...
ok.2:                                             ; preds = %entry
  ...
  store %Derp2* %tmp.11, %Derp2** %tmp.14, align 8
  ...
  %tmp.18 = load %Derp2*, %Derp2** %tmp.17, align 8
  %tmp.19 = bitcast %Derp2* %tmp.18 to %Derp2*
  %tmp.20 = getelementptr %Derp2, %Derp2* %tmp.19, i32 0, i32 0
  %tmp.21 = load %_Derp2_vtable*, %_Derp2_vtable** %tmp.20, align 8
  %tmp.22 = getelementptr %_Derp2_vtable, %_Derp2_vtable* %tmp.21, i32 0, i32 8
  %tmp.23 = load %String* (%Derp2*)*, %String* (%Derp2*)** %tmp.22, align 8
  %tmp.24 = call %String* %tmp.23(%Derp2* %tmp.19)
  %tmp.25 = alloca %Main*, align 8
  store %Main* %self, %Main** %tmp.25, align 8
  %tmp.26 = load %Main*, %Main** %tmp.25, align 8
  %tmp.27 = getelementptr %Main, %Main* %tmp.26, i32 0, i32 0
  %tmp.28 = load %_Main_vtable*, %_Main_vtable** %tmp.27, align 8
  %tmp.29 = getelementptr %_Main_vtable, %_Main_vtable* %tmp.28, i32 0, i32 7
  %tmp.30 = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %tmp.29, align 8
  %tmp.31 = call %Main* %tmp.30(%Main* %tmp.26, %String* %tmp.24)
  %tmp.32 = add i32 0, 0
  ret i32 %tmp.32
...
entry:
  %tmp.33 = alloca %Derp2*, align 8
  %tmp.34 = getelementptr %_Derp2_vtable, %_Derp2_vtable* @_Derp2_vtable_prototype, i32 0, i32 1
  %tmp.35 = load i32, i32* %tmp.34, align 4
  %tmp.36 = call i8* @malloc(i32 %tmp.35)
...
okay:                                             ; preds = %entry
  ...
  store %_Derp2_vtable* @_Derp2_vtable_prototype, %_Derp2_vtable** %tmp.38, align 8
  store %Derp2* %tmp.37, %Derp2** %tmp.33, align 8
  ret %Derp2* %tmp.37
...
entry:
  %tmp.39 = alloca %Derp2*, align 8
  store %Derp2* %self, %Derp2** %tmp.39, align 8
  %tmp.40 = load %Derp2*, %Derp2** %tmp.39, align 8
  %tmp.41 = icmp eq %Derp2* %tmp.40, null
  br i1 %tmp.41, label %abort, label %ok.3

ok.3:                                             ; preds = %entry
  %tmp.42 = alloca %String*, align 8
  store %String* @String.2, %String** %tmp.42, align 8
  %tmp.43 = load %String*, %String** %tmp.42, align 8
  ret %String* %tmp.43
...
entry:
  %tmp.44 = alloca %Derp1*, align 8
  %tmp.45 = getelementptr %_Derp1_vtable, %_Derp1_vtable* @_Derp1_vtable_prototype, i32 0, i32 1
  %tmp.46 = load i32, i32* %tmp.45, align 4
  %tmp.47 = call i8* @malloc(i32 %tmp.46)
...
okay:                                             ; preds = %entry
  ...
  store %_Derp1_vtable* @_Derp1_vtable_prototype, %_Derp1_vtable** %tmp.49, align 8
  store %Derp1* %tmp.48, %Derp1** %tmp.44, align 8
  ret %Derp1* %tmp.48
...
entry:
  %tmp.50 = alloca %Derp1*, align 8
  store %Derp1* %self, %Derp1** %tmp.50, align 8
  %tmp.51 = load %Derp1*, %Derp1** %tmp.50, align 8
  %tmp.52 = icmp eq %Derp1* %tmp.51, null
  br i1 %tmp.52, label %abort, label %ok.4

ok.4:                                             ; preds = %entry
  %tmp.53 = alloca %String*, align 8
  store %String* @String.1, %String** %tmp.53, align 8
  %tmp.54 = load %String*, %String** %tmp.53, align 8
  ret %String* %tmp.54
